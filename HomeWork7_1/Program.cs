...
namespace HomeWork7_1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double triangleArea1 = TriangleArea(triangleSide1_1, triangleSide1_2, triangleSide1_3);
            double triangleArea2 = TriangleArea(triangleSide2_1, triangleSide2_2, triangleSide2_3);
